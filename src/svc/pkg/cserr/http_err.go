...
func NewHTTPErrorFromError(ctx context.Context, e error, msg string, l cslog.Logger) *HTTPError {
	return &HTTPError{
...
// NewValidationHTTPError returns a new HTTPError of type Validation
func NewValidationHTTPError(ctx context.Context, msg string, l cslog.Logger) *HTTPError {
	return &HTTPError{
...
func NewValidationHTTPErrorFromError(ctx context.Context, e error, msg string, l cslog.Logger) *HTTPError {
	return &HTTPError{
		err: NewErrInvalid(msg),
		l:   l,
		ctx: ctx,
...
func NewNotFoundHTTPError(ctx context.Context, msg string, l cslog.Logger) *HTTPError {
	return &HTTPError{
...
// NewUnauthorizedHTTPError instantiates a new HTTPError of type NotFound
func NewUnauthorizedHTTPError(ctx context.Context, msg string, l cslog.Logger) *HTTPError {
	return &HTTPError{
		err: NewErrUnauthorized(errors.New(msg)),
		l:   l,
		ctx: ctx,
	}
}
...
func NewInternalServerHTTPError(ctx context.Context, msg string, l cslog.Logger) *HTTPError {
	return &HTTPError{
